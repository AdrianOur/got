...
def dosyasec():
	...
	if comboc=="":
		mesaj=" \nElige el archivo con el combo MAC"
		dir='./Combos/'
		dsy="\n       \33[1;4;94;47m 0=⫸ Mac Automática  \33[0m\n"
	else:
		mesaj="Selecciona tu combo\nSelecciona tu combo "
		dir='./Proxies/'
...
"""+dsy+"""
\33[33mCombos encontrados """ +str(say)+""" 
	""")
		...
		if comboc=="":
			if dsyno=="0" or dsyno=="":
				...
				if mactur=="":
		 			mactur=1
				randomturu=input("""
Elige combinación de MAC

\33[33mMAC consecutiva = \33[31m1
\33[33mMAC Aleatoria  = \33[31m2
		
\33[0m\33[1mOpción = \33[31m""")
				if randomturu=="":
		 			randomturu="2"
				serim=""
				serim=input("""\33[0m
\33[33mUsar MAC serial?\n
\33[1m\33[34mSi (1) \33[0m o \33[1m\33[32mNo (2) \33[0m Elige una opción 
		
Respuesta = """)
				mactur=yeninesil[int(mactur)-1]
				if serim =="1":
		 			seri=input("Ejemplo="+mactur+"\33[31m5\33[0m\nEjemplo="+mactur+"\33[31mFa\33[32m\nElige un valor \33[0m\n\33[1m"+mactur+"\33[31m")
				combouz=input("""\33[0m
		 		
Número de MAC a escanear?
